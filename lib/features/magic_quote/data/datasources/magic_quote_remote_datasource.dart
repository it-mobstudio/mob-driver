...
abstract interface class MagicQuoteRemoteDatasource {
  ...
  Future<Map<String, dynamic>> patchMagicQuote(Map<String, dynamic> body);

  Future<Map<String, dynamic>> deleteMagicQuoteItem(Map<String, dynamic> body);

  Future<Map<String, dynamic>> addMagicQuoteItem(Map<String, dynamic> body);
}

class MagicQuoteRemoteDatasourceImpl implements MagicQuoteRemoteDatasource {
  MagicQuoteRemoteDatasourceImpl(this._dio);
  ...
  @override
  Future<Map<String, dynamic>> patchMagicQuote(
  ...
  @override
  Future<Map<String, dynamic>> deleteMagicQuoteItem(
    Map<String, dynamic> body,
  ) async {
  ...
  @override
  Future<Map<String, dynamic>> addMagicQuoteItem(
    Map<String, dynamic> body,
  ) async {
    final response = await _dio.post<dynamic>(
      '/quote-builder/magic-quote/',
