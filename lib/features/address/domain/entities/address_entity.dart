class AddressEntity {
  ...
  factory AddressEntity.fromMap(Map<String, dynamic> map) {
    return AddressEntity(
      ...
      addressLine1:
          _stringValue(map, const ['address_line_1', 'address1']),
      addressLine2:
          _stringValue(map, const ['address_line_2', 'address2']),
      sitePerson:
          _stringValue(map, const ['site_person', 'delivery_person']),
      ...
      phoneNumber:
          _stringValue(map, const ['phone_number', 'phone', 'mobile']),
