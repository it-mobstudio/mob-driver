                      ...
                      children: [
                        ListView(
                          ...
                          children: [
                            ...
                            const _SectionTitle('Please select payment option'),
                            ...
                            _RazorpayTile(
                              ...
                              onTap: () => setState(() => _paymentOption = 1),
                            ),
                            const SizedBox(height: 20),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: checked ? const Color(0xFF0360E5) : const Color(0xFF767C8F),
        ),
